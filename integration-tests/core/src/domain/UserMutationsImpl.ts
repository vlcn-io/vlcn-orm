...
export function createImpl(
  ...
  throw new Error(
    "You must implement the mutation create for schema User in UserMutationsImpl.ts"
  );
}
...
export function renameImpl(
  ...
  // If you do return changesets, those changesets will be applied in addition to the changes made to the mutator.
  throw new Error(
    "You must implement the mutation rename for schema User in UserMutationsImpl.ts"
  );
}
...
export function deleteImpl(
  ...
  // If you do return changesets, those changesets will be applied in addition to the changes made to the mutator.
  throw new Error(
    "You must implement the mutation delete for schema User in UserMutationsImpl.ts"
  );
}
