...
export interface ICreateOrUpdateBuilder<T extends Object, M extends IModel<T>> extends IMutationBuilder<T, M> {
...
declare abstract class CreateOrUpdateBuilder<T extends Object, M extends IModel<T>> extends MutationBuilder<T, M> {
    set(newData: Partial<T>): this;
}
export declare abstract class CreationMutationBuilder<T extends Object, M extends IModel<T>> extends CreateOrUpdateBuilder<T, M> {
    constructor(spec: ModelSpec<T>);
    getChangeset(): CreateChangeset<M, T>;
}
export declare abstract class UpdateMutationBuilder<T extends Object, M extends IModel<T>> extends CreateOrUpdateBuilder<T, M> {
    private model;
