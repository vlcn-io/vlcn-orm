...
test('Generating an ID only model', () => {
    ...
    expect(contents).toEqual(`// SIGNED-SOURCE: <af8ef89465f19699d3ac1e3cf8a14efb>
...
test('Generating all primitive fields', () => {
    const contents = genIt(compileFromString(PrimitiveFieldsSchema)[1].nodes.PrimitiveFields).contents;
...
function genIt(schema) {
    return new GenTypescriptModel(schema).gen();
}
//# sourceMappingURL=GenTypescriptModel.test.js.map